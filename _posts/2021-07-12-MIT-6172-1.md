---
list_title: Note | MIT 6.172 - Introduction and Matrix Multiplication
...
We stop here as it beats the Intel MKL library which contains engineered math kernels for doing matmul. But we conly beats 
