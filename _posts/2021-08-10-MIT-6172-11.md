...
<mark>Mark-and-sweep doesn't deal with fragmentation</mark>. It doesn't compact the live objects to be contiguous in memory. It just frees the ones that are unreachable. It doesn't do anything with the ones that are reachable.
