---
layout: post
list_title: Computational Investment Part 1
...
综上所述，公司的价值为：<mark>未来估值+净资产</mark>。另一种更直观的计算方式为：#outstandign shares * price >即<mark>流通股数 * 股票价格</mark
